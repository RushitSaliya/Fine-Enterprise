...
class Ui_MainDialog(object):
    def setupUi(self, MainDialog):
        ...
        self.btn_toal_details = QtWidgets.QPushButton(MainDialog)
        self.btn_toal_details.setEnabled(True)
        self.btn_toal_details.setObjectName("btn_toal_details")
        self.gridLayout.addWidget(self.btn_toal_details, 4, 1, 1, 1)
        ...
        self.btn_view_and_delete_data = QtWidgets.QPushButton(MainDialog)
        self.btn_view_and_delete_data.setEnabled(True)
        self.btn_view_and_delete_data.setObjectName("btn_view_and_delete_data")
        self.gridLayout.addWidget(self.btn_view_and_delete_data, 2, 2, 1, 1)

        self.retranslateUi(MainDialog)
        self.radio_btn_selling.clicked.connect(self.btn_enter_data.show)
        self.radio_btn_selling.clicked.connect(self.btn_view_and_delete_data.show)
        self.radio_btn_selling.clicked.connect(self.btn_toal_details.show)
        self.radio_btn_purchase.clicked.connect(self.btn_enter_data.show)
        self.radio_btn_purchase.clicked.connect(self.btn_view_and_delete_data.show)
        self.radio_btn_purchase.clicked.connect(self.btn_toal_details.show)
    ...
    def retranslateUi(self, MainDialog):
        ...
        self.btn_toal_details.setText(_translate("MainDialog", "View Totals"))
        self.btn_enter_data.setText(_translate("MainDialog", "Enter Data"))
        self.btn_view_and_delete_data.setText(_translate("MainDialog", "View and Delete Data"))
